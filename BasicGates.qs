...
namespace Quantum.Kata.BasicGates {
    ...
    is Adj {
        // ...
		// Why is this not multiplied by 2.0 but the Ry one is?
		// TODO: wtf?
		Rz(alpha, q);
    }
    
    
	//note that next few ones you only have to do it to one bit because of entanglement
    ...
    is Adj {        
		...
		// 3 different implementations because I'm so cool (not srs)
